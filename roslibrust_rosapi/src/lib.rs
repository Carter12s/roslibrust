...
use roslibrust_common::RosLibRustResult;
...
pub trait RosApi {
    fn get_time(
        &self,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::GetTimeResponse>> + Send;
    fn topics(
        &self,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::TopicsResponse>> + Send;
    fn get_topic_type(
        &self,
        topic: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::TopicTypeResponse>> + Send;
    fn get_topics_for_type(
        &self,
        topic_type: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::TopicsForTypeResponse>> + Send;
    fn get_nodes(
        &self,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::NodesResponse>> + Send;

    fn get_node_details(
        &self,
        node: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::NodeDetailsResponse>> + Send;

    fn get_node_for_service(
        &self,
        service: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::ServiceNodeResponse>> + Send;

    fn set_param(
        &self,
        param_name: impl Into<String> + Send,
        param_value: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::SetParamResponse>> + Send;

    fn get_param(
        &self,
        param_name: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::GetParamResponse>> + Send;

    fn get_param_names(
        &self,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::GetParamNamesResponse>> + Send;

    fn has_param(
        &self,
        param: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::HasParamResponse>> + Send;

    fn delete_param(
        &self,
        name: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::DeleteParamResponse>> + Send;

    fn message_details(
        &self,
        message_name: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::MessageDetailsResponse>> + Send;

    fn publishers(
        &self,
        topic: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::PublishersResponse>> + Send;

    fn service_host(
        &self,
        service: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::ServiceHostResponse>> + Send;

    fn service_providers(
        &self,
        service_type: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::ServiceProvidersResponse>> + Send;

    fn get_service_request_details(
        &self,
        service_type: impl Into<String> + Send,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::ServiceRequestDetailsResponse>> + Send;
    ...
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::ServiceTypeResponse>> + Send;

    fn get_services(
        &self,
    ) -> impl std::future::Future<Output = RosLibRustResult<rosapi::ServicesResponse>> + Send;
}
